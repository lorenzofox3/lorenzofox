        ...
        <div>
            ...
            <main>
                <p>
                    ...
                    Every time the circumstances were different in such a way I could work for <a href="">big
                    companies</a>, with
                    a <a href="">startup</a> or a smaller <a href="">non profit structures</a>. It has been within a
                    team, remotely or alone; in French,
                    English or Spanish. You will have understood:
                    I <strong>adapt</strong>.
                </p>
                <p>
                    I love to create the architecture of a system and find <strong>simple solutions to complex
                    problems</strong>. I will prefer an adapted solution based on the needs and the constraints over the
                    trend of a technology.
                </p>
                <p>
                ...
                <p>
                    ...
                    of <strong>curiosity</strong>, <strong>humility</strong> and <strong>empathy</strong>. Instead of
                    frightening me, I see these requirements as an opportunity to grow and learn.
                </p>
            </main>
        </div>);
};
